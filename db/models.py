# db/models.py
# INFLUE — Estrutura simplificada de persistência (SQLite)
# Foco: manter o sistema operacional e funcional com o mínimo possível.
...
DB_PATH = os.environ.get("DATABASE_URL", "sqlite:///influe.db")
